...
#include "GGGoatGear_Skel_Base.generated.h"
...
class GOAT2_API UGGGoatGear_Skel_Base : public USkeletalMeshComponent, public IGGGoatGearInterface {
    GENERATED_BODY()
public:
private:
...
public:
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, GlobalConfig, meta=(AllowPrivateAccess=true))
    bool bUseGoatMeshAsSkinnedMasterPose;
...
public:
    UGGGoatGear_Skel_Base(const FObjectInitializer& ObjectInitializer);
