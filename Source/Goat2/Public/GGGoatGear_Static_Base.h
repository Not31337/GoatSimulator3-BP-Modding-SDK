...
#include "GGGoatGear_Static_Base.generated.h"
...
UCLASS(Blueprintable, EditInlineNew, ClassGroup=Custom, Config=GearSettings, meta=(BlueprintSpawnableComponent))
class GOAT2_API UGGGoatGear_Static_Base : public UStaticMeshComponent, public IGGGoatGearInterface {
    GENERATED_BODY()
public:
private:
...
private:
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, ReplicatedUsing=OnRep_bPassiveEffectActive, meta=(AllowPrivateAccess=true))
...
public:
    UGGGoatGear_Static_Base(const FObjectInitializer& ObjectInitializer);
