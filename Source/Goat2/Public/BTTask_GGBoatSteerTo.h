...
#include "BTTask_GGBoatSteerTo.generated.h"

class AGGVehicle_Boat;

UCLASS(Blueprintable)
class GOAT2_API UBTTask_GGBoatSteerTo : public UBTTaskNode {
    GENERATED_BODY()
public:
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    bool bCanGoBackwardsIfCloseEnough;
...
private:
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    AGGVehicle_Boat* Vehicle;
    
public:
    UBTTask_GGBoatSteerTo();
